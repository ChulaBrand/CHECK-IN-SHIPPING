  ...
  return (
    <>
      ...
      {phase === "success" && (
        <>
          <CornerLogo />
          <div className="mx-auto w-full max-w-[800px] overflow-hidden rounded-2xl bg-white shadow-2xl">
      ...
      {phase === "question" && (
        <div className="w-full">
          <CornerLogo />
          {submitFailed && (
            <div className="mx-auto mb-4 w-full max-w-[800px] rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-center text-red-800">
              {APPS_SCRIPT_URL
